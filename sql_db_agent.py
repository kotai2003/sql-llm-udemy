...
# llm_name = "gpt-4.1"
model = ChatOpenAI(model_name=llm_name, openai_api_key=openai_key)
...
# create a database from csv file using sqlite in memory

# path to your SQLite database file
database_file_path = "./db/salay.db"

# create an engine to connect to the SQLite database
# SQlite only requires the database file path
...
# QUESTION = """
# How many employees are in the ABS 85 Administrative Services,
# and their average salaray, and also how many of them are female?
# """
QUESTION = """
What is the highest average salary by department, and give me the number?
"""
